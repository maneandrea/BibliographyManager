...
class Root:
    ...
    def __init__(self, master, bibliography, *args, **kwargs):
        ...
        self.catmenu.add_radiobutton(label="cs", variable=self.def_cat, value="cs")
        self.catmenu.add_radiobutton(label="math", variable=self.def_cat, value="math")
        self.catmenu.add_radiobutton(label="q-bio", variable=self.def_cat, value="q-bio")
        self.catmenu.add_radiobutton(label="q-fin", variable=self.def_cat, value="q-fin")
        self.catmenu.add_radiobutton(label="stat", variable=self.def_cat, value="stat")
        self.catmenu.add_radiobutton(label="eess", variable=self.def_cat, value="eess")
        self.catmenu.add_radiobutton(label="econ", variable=self.def_cat, value="econ")
